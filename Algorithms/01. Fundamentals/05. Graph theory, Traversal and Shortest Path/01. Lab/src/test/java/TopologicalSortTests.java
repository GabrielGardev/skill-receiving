...
public class TopologicalSortTests {
    ...
    public void TestTopSortAcyclicGraph6Vertices() {
        ...
        // Act
        Collection<String> topSorter = P02_Source_Removal_Topological_Sorting.topSort(graph);
    ...
    public void TestTopSortGraph1Vertex() {
        ...
        // Act
        Collection<String> topSorted = P02_Source_Removal_Topological_Sorting.topSort(graph);
