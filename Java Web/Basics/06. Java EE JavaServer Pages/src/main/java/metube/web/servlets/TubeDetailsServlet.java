...
public class TubeDetailsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        TubeDetailsViewModel viewModel =
                modelMapper.map(tubeService.findTubeByName(name), TubeDetailsViewModel.class);

        req.setAttribute("tubeDetailsViewModel", viewModel);
